Aquí tienes el contenido del **README** traducido al inglés, con el tema de **Reinforcement Learning** incluido:
...
Each folder contains examples and resources to facilitate the study and experimentation in each area. The notebooks are designed to be interactive and educational, while the scripts allow for repeatable experimentation.
